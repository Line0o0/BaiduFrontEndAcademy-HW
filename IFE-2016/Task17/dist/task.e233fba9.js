...
function graTimeChange() {} // 确定是否选项发生了变化
// 设置对应数据
// 调用图表渲染函数
...
function citySelectChange() {} // 确定是否选项发生了变化
// 设置对应数据
// 调用图表渲染函数
...
function initCitySelector() {} // 读取aqiSourceData中的城市，然后设置id为city-select的下拉列表中的选项
...
function initAqiChartData() {} // 将原始的源数据处理成图表需要的数据格式
