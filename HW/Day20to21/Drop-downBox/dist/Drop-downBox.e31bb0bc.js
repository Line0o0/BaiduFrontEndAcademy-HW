...
function handleSelect() {
  ...
  try {
    for (var _iterator = status[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      if (element.checked) {
        var ID = element.getAttribute('id') + "-select";
        document.getElementById(ID).className = "selected";
      } else {
        var _ID = element.getAttribute('id') + "-select";

        document.getElementById(_ID).className = "select";
      }
    }
  } catch (err) {
...
//# sourceMappingURL=/Drop-downBox.e31bb0bc.js.map