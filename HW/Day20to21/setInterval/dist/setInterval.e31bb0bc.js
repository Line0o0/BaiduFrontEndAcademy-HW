...
var btnReset = document.forms[0].elements["btnReset"]; //定义定时器的id
...
btnStart.onclick = function () {
  ...
  if (this.value == "开始") {
    //使按钮文本变为停止       
    this.value = "停止"; //使重置按钮不可用       

    btnReset.disabled = true; //设置定时器，每0.01s跳一次       

    id = window.setInterval(tip, 10);
  } else {
    //使按钮文本变为开始       
    this.value = "开始"; //使重置按钮可用       
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "12422" + '/');
...
//# sourceMappingURL=/setInterval.e31bb0bc.js.map